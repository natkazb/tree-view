...
<?php foreach ($items as $item) : ?>
    <details draggable="true" class="Nzbiranik_tree_draggable_item" data-id="<?= $item[$widget->idField] ?>" data-title="<?= $item[$widget->titleField] ?>"
