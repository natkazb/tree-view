...
<?php foreach ($items as $item) : ?>
    <details draggable="true" class="Nzbiranik-tree_draggable-item" data-id="<?php echo $item[$widget->idField] ?>">
        <summary>
            ...
            <div class="Nzbiranik-tree__button-move Nzbiranik-tree__button-move-down">
            ...
            <div class="Nzbiranik-tree__button-move Nzbiranik-tree__button-move-up">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <?php if (!empty($widget->addChildUrl)) : ?>
                <div class="Nzbiranik-tree__button-move Nzbiranik-tree__add-child">
                    <a href="<?php echo Url::to([$widget->addChildUrl, 'parent' => $item[$widget->idField]]) ?>">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
